...
set_property PACKAGE_PIN E3 [get_ports sys_clk_pin]							
...
set_property PACKAGE_PIN C2 [get_ports {sdData0}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {sdData0}]
##Bank = 35, Pin name = IO_L18N_T2_35,						Sch name = SD_DAT1
set_property PACKAGE_PIN E1 [get_ports {sdData1}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {sdData1}]
##Bank = 35, Pin name = IO_L18P_T2_35,						Sch name = SD_DAT2
set_property PACKAGE_PIN F1 [get_ports {sdData2}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {sdData2}]
##Bank = 35, Pin name = IO_L14N_T2_SRCC_35,					Sch name = SD_DAT3
set_property PACKAGE_PIN D2 [get_ports {sdData3}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {sdData3}]
...
set_property PACKAGE_PIN D10 [get_ports {PhyRxd0}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {PhyRxd0}]
##Bank = 16, Pin name = IO_L13P_T2_MRCC_16,					Sch name = ETH_RXD1
set_property PACKAGE_PIN C11 [get_ports {PhyRxd1}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {PhyRxd1}]
...
set_property PACKAGE_PIN A10 [get_ports {PhyTxd0}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {PhyTxd0}]
##Bank = 16, Pin name = IO_L12N_T1_MRCC_16,					Sch name = ETH_TXD1
set_property PACKAGE_PIN A8 [get_ports {PhyTxd1}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {PhyTxd1}]
